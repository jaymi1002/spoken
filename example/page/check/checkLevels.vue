      ...
      <e-accordion
        ...
        <e-accordion-item
          ...
          <e-accordion-header>
            <p class="font16">
              <e-icon
                :type="getIconType(item.select.length,item.list.length)"
                :color="getIconColor(item.select.length,item.list.length)"
                :size="20"
                class="mr20"
                @click.stop="choose(index)"/>{{ item.title }}</p>
          </e-accordion-header>
          <e-accordion-content>
            <e-check-list
              ref="checkStudent"
