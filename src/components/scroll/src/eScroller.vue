<template>
    <div class="scroller" :id="myId">
        <div class="scroller-main" ref="scrollMain">
            ...
            <div class="scroller-item font14" v-for="(el,index) in list" :key="index">
                <p v-if="!wheel">{{el}}</p>
            </div>
            <div class="placeholder"></div>
        </div>
        ...
        <template v-if="wheel">
            <div ref="wheel" class="wheel-div">
                <div class="wheel-item font14" v-for="(el,index) in list" :key="index" :style="{'transform':`rotateX(${(-index)*25}deg) translate3d(0px, 0px, 3.25rem)`}">
