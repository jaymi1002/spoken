...
export default {
    ...
    computed: {
        ...
        currentPath() {
            ...
            endX = 50 - Math.floor(Math.sin(this.degree * PI / 180) * 1000) / 1000 * this.r;
            endY = 50 + Math.floor(Math.cos(this.degree * PI / 180) * 1000) / 1000 * this.r;
    ...
    watch: {
        ...
        currentProgress(newVal) {
            ...
            this.degree = this.initDeg + (newVal / 100 * (360 - 2 * this.initDeg));
        }
    }
};
